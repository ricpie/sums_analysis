...
```{r load_data, warning=FALSE}
  ...
  kable(HHID_remove) #List of houses that have been flagged for exclusion
  kable(bad_files) #List of files that have been flagged for exclusion
  kable(stove_codes) #List of stove codes
```
...
not_ok_cooking_events <- dplyr::filter(ok_cooking_events_unfiltered,!grepl("ok",qc)) %>% #Keep only data marked 'ok'
                          droplevels() #Getting rid of extra levels whos data was filtered out, so unique doesn't freak out.
