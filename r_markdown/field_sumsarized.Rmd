...
```{r plot_all_timeseries, fig.width=10, fig.height=50}
...
```{r boxplots_usage, fig.width=6, fig.height=4}
...
```{r plot_time_trends, fig.width=10, fig.height=4}
...
```{r plot_usage_fractions, fig.width=6, fig.height=4}
...
```{r plot_monitoring_diagnostics, fig.width=6, fig.height=4}
